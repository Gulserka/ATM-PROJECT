...
public class Options extends atmproject.Account {
    ...
    public void login() {
        ...
        do {
            ...
            try {
                ...
                setAccountNumber(input.nextInt());  //daha hıc atama yapılmamıs old ıcın set ıle data gırılmesını saglıyoruz.
                ...
                input.nextLine();  //nextLine yapmamizin sebebi: Bazen (String int gecislerinde) Scanner icindeki methodlarin
                // birbiriyle carpisma ihtimalleri oluyor aralarinda oncelik siralamasi olcagi icin Line islemlerin arasina
                // bosluk koyar sikinti olmaz.
...
//        }
    ...
    public void displayMessage() {    //genelde altta olur
